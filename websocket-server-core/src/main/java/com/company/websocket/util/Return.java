...
public class Return extends HashMap<String, Object> {
    ...
    public static Return SUCCESS(MsgCode msgCode) {
        return SUCCESS(msgCode.code, msgCode.note);
    }
    ...
    public static Return FAIL(MsgCode msgCode) {
        return FAIL(msgCode.code, msgCode.note);
    }

    public static Return FAIL(MsgCode msgCode, Exception e) {
        return FAIL(msgCode.code, stacktrace(e));
    }
    ...
    public Integer get_code() {
        return (Integer) this.getOrDefault(Return_Fields.code.name(), MsgCode.error.code);
    }
