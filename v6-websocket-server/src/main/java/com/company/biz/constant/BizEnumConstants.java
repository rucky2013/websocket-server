package com.company.biz.constant;

/**
 * Created by BG244210 on 26/10/2017.
 */
public interface BizEnumConstants {
    ...
    public enum MsgCodeEnum {
        ...
        private MsgCodeEnum(Integer code, String note) {
            this.note = note;
            this.code = code;
        }
    }
    ...
    public enum ServiceIdEnum {
        ...
        ServiceIdEnum(Integer code, String note) {
            this.code = code;
            this.note = note;
        }
    }
